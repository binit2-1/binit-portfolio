...
![Debouncing search preview](/videos/writings/debouncing-mechanics/not-debounce.webm "Debouncing mechanics")
...
![Flipkart debounced search](/videos/writings/debouncing-mechanics/flipkart-debounced.webm "Flipkart debounced search")
<!-- media: autoplay loop muted caption=false -->
...
![Implemented debounced search](/videos/writings/debouncing-mechanics/debounce-react.webm "Implemented debounced search")
<!-- media: autoplay loop muted caption=false -->
...
![Debounced search timer](/videos/writings/debouncing-mechanics/debounce-with-timer.webm "Debounced search timer")
<!-- media: autoplay loop muted caption=false -->
